...
export type ContentWageHistoryListLineChartQuery = { __typename?: 'Query', contentWageHistoryList: Array<{ __typename?: 'ContentWithHistories', content: { __typename?: 'Content', displayName: string, id: number, contentCategory: { __typename?: 'ContentCategory', name: string } }, histories: Array<{ __typename?: 'ContentWageHistory', goldAmountPerHour: number, date: string }> }> };
