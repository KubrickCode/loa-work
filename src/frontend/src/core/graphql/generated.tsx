...
export type ContentRewardListPieChartQuery = { __typename?: 'Query', contentList: Array<{ __typename?: 'Content', id: number, displayName: string, contentRewards: Array<{ __typename?: 'ContentReward', averageQuantity: number, isSellable: boolean, contentRewardItem: { __typename?: 'ContentRewardItem', id: number, name: string, price: number } }>, contentSeeMoreRewards: Array<{ __typename?: 'ContentSeeMoreReward', quantity: number, contentRewardItem: { __typename?: 'ContentRewardItem', id: number, name: string, price: number } }> }> };
