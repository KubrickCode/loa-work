...
export type ContentRewardListPieChartQuery = { __typename?: 'Query', contentList: Array<{ __typename?: 'Content', contentRewards: Array<{ __typename?: 'ContentReward', averageQuantity: number, isSellable: boolean, item: { __typename?: 'Item', id: number, name: string, pieColor: string; price: number, } }>, contentSeeMoreRewards: Array<{ __typename?: 'ContentSeeMoreReward', item: { __typename?: 'Item', id: number, name: string, pieColor: string; price: number, }; quantity: number, }>; displayName: string, id: number, }> };
...
export type ContentWageListBarChartQuery = { __typename?: 'Query', contentWageList: Array<{ __typename?: 'ContentWage', content: { __typename?: 'Content', contentCategory: { __typename?: 'ContentCategory', name: string }; displayName: string, }; goldAmountPerHour: number, krwAmountPerHour: number, }> };
...
export type ContentGroupWageListBarChartQuery = { __typename?: 'Query', contentGroupWageList: Array<{ __typename?: 'ContentGroupWage', contentGroup: { __typename?: 'ContentGroup', contentCategory: { __typename?: 'ContentCategory', name: string }; name: string, }; goldAmountPerHour: number, krwAmountPerHour: number, }> };
