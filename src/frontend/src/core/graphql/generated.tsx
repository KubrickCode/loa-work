...
export type Query = {
  ...
  contentRewardItemList: Array<Scalars['String']['output']>;
...
export type ContentRewardListTableQuery = { __typename?: 'Query', contentRewardItemList: Array<string>, contentList: Array<{ __typename?: 'Content', displayName: string, id: number, level: number, contentCategory: { __typename?: 'ContentCategory', name: string }, contentRewards: Array<{ __typename?: 'ContentReward', averageQuantity: number, isSellable: boolean, itemName: string }> }> };
