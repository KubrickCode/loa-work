...
export type ContentDetailsDialogQuery = { __typename?: 'Query', content: { __typename?: 'Content', level: number, name: string, contentCategory: { __typename?: 'ContentCategory', imageUrl: string, name: string } } };
