...
export type Query = {
  ...
  contentRewardItems: Array<Scalars['String']['output']>;
...
export type ContentRewardEditDialogQuery = { __typename?: 'Query', content: { __typename?: 'Content', contentRewards: Array<{ __typename?: 'ContentReward', averageQuantity: number, id: number, isSellable: boolean, itemName: string }> } };
...
export type ContentRewardListTableQuery = { __typename?: 'Query', contentRewardItems: Array<string>, contentList: Array<{ __typename?: 'Content', displayName: string, duration: number, id: number, level: number, contentCategory: { __typename?: 'ContentCategory', name: string }, contentRewards: Array<{ __typename?: 'ContentReward', averageQuantity: number, isSellable: boolean, itemName: string }> }> };
...
export type ContentWageListTableQuery = { __typename?: 'Query', contentList: Array<{ __typename?: 'Content', displayName: string, contentCategory: { __typename?: 'ContentCategory', name: string }, wage: { __typename?: 'ContentWage', amount: number, goldAmount: number } }> };

export type ContentRewardItemsFilterQueryVariables = Exact<{ [key: string]: never; }>;


export type ContentRewardItemsFilterQuery = { __typename?: 'Query', contentRewardItems: Array<string> };
