  ...
  theme: {
    ...
    semanticTokens: {
      colors: {
        text: {
          primary: {
            value: { _light: "{colors.neutral.700}", _dark: "#F8F9FA" },
          },
          secondary: {
            value: { _light: "{colors.neutral.500}", _dark: "#E1E3E7" },
          },
          muted: {
            value: { _light: "{colors.neutral.400}", _dark: "#A8ABAF" },
          },
        },
        ...
        bg: {
          ...
          surface: {
            value: { _light: "white", _dark: "{colors.neutral.850}" },
          },
