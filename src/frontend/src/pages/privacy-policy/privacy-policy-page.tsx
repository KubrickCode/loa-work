...
export const PrivacyPolicyPage = () => {
  return (
    ...
    >
      ...
      <Text mb={4}>
        This privacy policy applies to the loa-work app (hereby referred to as
        "Application") for mobile devices that was created by Kubrickcode
      ...
      <Text mb={4}>
        ...
        displayName, imageUrl. The information that the Service Provider request
