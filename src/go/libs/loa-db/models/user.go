...
type User struct {
	...
	Provider    AuthProvider `boil:"provider" json:"provider" toml:"provider" yaml:"provider"`
...
type whereHelperAuthProvider struct{ field string }

func (w whereHelperAuthProvider) EQ(x AuthProvider) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.EQ, x)
}
func (w whereHelperAuthProvider) NEQ(x AuthProvider) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.NEQ, x)
}
func (w whereHelperAuthProvider) LT(x AuthProvider) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LT, x)
}
func (w whereHelperAuthProvider) LTE(x AuthProvider) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.LTE, x)
}
func (w whereHelperAuthProvider) GT(x AuthProvider) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GT, x)
}
func (w whereHelperAuthProvider) GTE(x AuthProvider) qm.QueryMod {
	return qmhelper.Where(w.field, qmhelper.GTE, x)
}
func (w whereHelperAuthProvider) IN(slice []AuthProvider) qm.QueryMod {
...
func (w whereHelperAuthProvider) NIN(slice []AuthProvider) qm.QueryMod {
	values := make([]interface{}, 0, len(slice))
	for _, value := range slice {
		values = append(values, value)
	}
...
var UserWhere = struct {
	...
	Provider    whereHelperAuthProvider
	...
	ImageURL:    whereHelpernull_String{field: "\"user\".\"image_url\""},
	Provider:    whereHelperAuthProvider{field: "\"user\".\"provider\""},
	RefID:       whereHelperstring{field: "\"user\".\"ref_id\""},
	Role:        whereHelperUserRole{field: "\"user\".\"role\""},
}
...
type userR struct {
	UserGoldExchangeRate      *UserGoldExchangeRate         `boil:"UserGoldExchangeRate" json:"UserGoldExchangeRate" toml:"UserGoldExchangeRate" yaml:"UserGoldExchangeRate"`
...
func (o *User) GetUserGoldExchangeRate() *UserGoldExchangeRate {
	if o == nil {
		return nil
	}

	return o.R.GetUserGoldExchangeRate()
}

func (r *userR) GetUserGoldExchangeRate() *UserGoldExchangeRate {
	if r == nil {
		return nil
	}

	return r.UserGoldExchangeRate
}

func (o *User) GetReportedContentRewards() ReportedContentRewardSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetReportedContentRewards() ReportedContentRewardSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetUserContentDurations() UserContentDurationSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetUserContentDurations() UserContentDurationSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetUserContentRewards() UserContentRewardSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetUserContentRewards() UserContentRewardSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetUserContentSeeMoreRewards() UserContentSeeMoreRewardSlice {
	if o == nil {
		return nil
	}
...
func (r *userR) GetUserContentSeeMoreRewards() UserContentSeeMoreRewardSlice {
	if r == nil {
		return nil
	}
...
func (o *User) GetUserItems() UserItemSlice {
	if o == nil {
		return nil
	}
...
var (
	userAllColumns            = []string{"id", "created_at", "updated_at", "display_name", "email", "image_url", "provider", "ref_id", "role"}
	userColumnsWithoutDefault = []string{"updated_at", "display_name", "provider", "ref_id"}
	userColumnsWithDefault    = []string{"id", "created_at", "email", "image_url", "role"}
...
// UserGoldExchangeRate pointed to by the foreign key.
func (o *User) UserGoldExchangeRate(mods ...qm.QueryMod) userGoldExchangeRateQuery {
	...
	return UserGoldExchangeRates(queryMods...)
}

// ReportedContentRewards retrieves all the reported_content_reward's ReportedContentRewards with an executor.
func (o *User) ReportedContentRewards(mods ...qm.QueryMod) reportedContentRewardQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"reported_content_reward\".\"user_id\"=?", o.ID),
	)
...
func (o *User) UserContentDurations(mods ...qm.QueryMod) userContentDurationQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_content_duration\".\"user_id\"=?", o.ID),
	)
...
func (o *User) UserContentRewards(mods ...qm.QueryMod) userContentRewardQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_content_reward\".\"user_id\"=?", o.ID),
	)
...
func (o *User) UserContentSeeMoreRewards(mods ...qm.QueryMod) userContentSeeMoreRewardQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"user_content_see_more_reward\".\"user_id\"=?", o.ID),
	)
...
func (o *User) UserItems(mods ...qm.QueryMod) userItemQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"user_item\".\"user_id\"=?", o.ID),
	)

	return UserItems(queryMods...)
}

// LoadUserGoldExchangeRate allows an eager lookup of values, cached into the
// loaded structs of the objects. This is for a 1-1 relationship.
func (userL) LoadUserGoldExchangeRate(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`user_gold_exchange_rate`),
		qm.WhereIn(`user_gold_exchange_rate.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
	...
	if err != nil {
		return errors.Wrap(err, "failed to eager load UserGoldExchangeRate")
	}

	var resultSlice []*UserGoldExchangeRate
	if err = queries.Bind(results, &resultSlice); err != nil {
		return errors.Wrap(err, "failed to bind eager loaded slice UserGoldExchangeRate")
	}

	if err = results.Close(); err != nil {
		return errors.Wrap(err, "failed to close results of eager load for user_gold_exchange_rate")
	}
	if err = results.Err(); err != nil {
		return errors.Wrap(err, "error occurred during iteration of eager loaded relations for user_gold_exchange_rate")
	}
	...
	if singular {
		...
		object.R.UserGoldExchangeRate = foreign
		if foreign.R == nil {
			foreign.R = &userGoldExchangeRateR{}
		}
	...
	for _, local := range slice {
		for _, foreign := range resultSlice {
			if local.ID == foreign.UserID {
				local.R.UserGoldExchangeRate = foreign
				if foreign.R == nil {
					foreign.R = &userGoldExchangeRateR{}
				}
...
func (userL) LoadReportedContentRewards(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`reported_content_reward.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserContentDurations(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_content_duration.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserContentRewards(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_content_reward.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (userL) LoadUserContentSeeMoreRewards(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		...
		qm.WhereIn(`user_content_see_more_reward.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadUserItems(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`user_item`),
		qm.WhereIn(`user_item.user_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
// SetUserGoldExchangeRateG of the user to the related item.
// Sets o.R.UserGoldExchangeRate to related.
// Adds o to related.R.User.
// Uses the global database handle.
func (o *User) SetUserGoldExchangeRateG(ctx context.Context, insert bool, related *UserGoldExchangeRate) error {
	return o.SetUserGoldExchangeRate(ctx, boil.GetContextDB(), insert, related)
}

// SetUserGoldExchangeRate of the user to the related item.
// Sets o.R.UserGoldExchangeRate to related.
// Adds o to related.R.User.
func (o *User) SetUserGoldExchangeRate(ctx context.Context, exec boil.ContextExecutor, insert bool, related *UserGoldExchangeRate) error {
	var err error
	...
	if o.R == nil {
		o.R = &userR{
			UserGoldExchangeRate: related,
		}
	} else {
		o.R.UserGoldExchangeRate = related
	}

	if related.R == nil {
		related.R = &userGoldExchangeRateR{
			User: o,
		}
	} else {
		related.R.User = o
...
// Uses the global database handle.
func (o *User) AddReportedContentRewardsG(ctx context.Context, insert bool, related ...*ReportedContentReward) error {
...
// Appends related to o.R.ReportedContentRewards.
// Sets related.R.User appropriately.
func (o *User) AddReportedContentRewards(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ReportedContentReward) error {
	var err error
...
// Sets related.R.User appropriately.
// Uses the global database handle.
func (o *User) AddUserContentDurationsG(ctx context.Context, insert bool, related ...*UserContentDuration) error {
...
// Appends related to o.R.UserContentDurations.
// Sets related.R.User appropriately.
func (o *User) AddUserContentDurations(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserContentDuration) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
...
// Sets related.R.User appropriately.
// Uses the global database handle.
func (o *User) AddUserContentRewardsG(ctx context.Context, insert bool, related ...*UserContentReward) error {
...
// Appends related to o.R.UserContentRewards.
// Sets related.R.User appropriately.
func (o *User) AddUserContentRewards(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserContentReward) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
...
// Sets related.R.User appropriately.
// Uses the global database handle.
func (o *User) AddUserContentSeeMoreRewardsG(ctx context.Context, insert bool, related ...*UserContentSeeMoreReward) error {
...
// Appends related to o.R.UserContentSeeMoreRewards.
// Sets related.R.User appropriately.
func (o *User) AddUserContentSeeMoreRewards(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*UserContentSeeMoreReward) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.UserID = o.ID
...
// Sets related.R.User appropriately.
// Uses the global database handle.
func (o *User) AddUserItemsG(ctx context.Context, insert bool, related ...*UserItem) error {
